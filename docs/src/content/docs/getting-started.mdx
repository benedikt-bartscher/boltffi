...
The program prints `5`. See [linking a C program](/docs/c#link-a-c-program) for Windows commands and [memory management](/docs/c#memory-management) for cleanup rules.
