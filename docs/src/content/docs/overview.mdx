...
| C | [Experimental; synchronous APIs](/docs/experimental#c) |
| Python | Supported |
| C++ | Planned |
| Ruby | Planned |
| Dart | In progress |
...
C currently supports the synchronous APIs described above, with limits on callbacks. Async and stream examples apply to the other targets. See [C limitations](/docs/experimental#c).
