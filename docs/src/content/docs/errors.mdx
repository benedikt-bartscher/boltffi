---
title: "Errors"
description: "Map Rust Result<T, E> into native error handling in Swift, Kotlin, Java, C#, TypeScript, Python, and C with BoltFFI using string errors and structured error types."
---
...
- C: the typed result contains the error record, enum, or string in `data.error`
...
- C: `DemoString` in the active result union for a package named `demo`
